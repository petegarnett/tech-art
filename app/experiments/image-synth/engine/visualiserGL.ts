...
export class VisualiserGL {
  private canvas: HTMLCanvasElement | null = null;
  private gl: WebGL2RenderingContext | null = null;
  private vert: WebGLShader | null = null;
  private programs: Map<PresetId, CompiledProgram> = new Map();
  private currentPreset: PresetId = "glitch";
  ...
  private compilePreset(id: PresetId): CompiledProgram | null {
    const gl = this.gl;
  ...
  draw(): void {
    ...
    for (const p of PRESET_BY_ID[this.currentPreset].params) {
      const loc = U[p.name];
